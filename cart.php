            ...
            <div class="table-responsive">
                ...
                <thead class="thead-light">
					...
					<tr>
						...
						<td>me</td>
						<td>1</td>
						<td><button class='btn btn-danger'>DELETE</button><button class='btn btn-success' ><a href="checkout.php">CART</button></td>
					</tr>
                    
                </thead>
                </table>
            </div>
            <a href="checkout.php" id="checkoutbutton">Checkout</a>
            </div>
        </div>
    </div>
</div>
