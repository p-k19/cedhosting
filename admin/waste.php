							...
							aria-haspopup="true" aria-expanded="false">
								<div class="media align-items-center">
									...
									<div class="media-body  ml-2  d-none d-lg-block">
										<span class="mb-0 text-sm  font-weight-bold">Hello, vivek kushwaha</span>
									</div>
								</div>
							</a>
								...
								<div class="pl-lg-4">
									...
									<div class="form-group col-lg-6">
										...
										name="productcategory">
												...
												<option value="25">WordPress</option><option value="26">Mac Hosting</option><option value="27">windows hosting</option><option value="52">Linux</option><option value="53">mac host</option><option value="55">hey</option><option value="58">qwerty</option><option value="61">Prix 2.0</option><option value="63">triphosting</option><option value="74">Prix 2.1</option><option value="75">host111</option><option value="77">null</option>										</select>
